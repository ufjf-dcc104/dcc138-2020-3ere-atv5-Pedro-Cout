...
export default class CenaJogo extends Cena {
    ...
    preparar() {
        ...
        pc.controlar = function(dt) {
            ...
            if(cena.input.comandos.get("MOVE_ACIMA")) {
                this.vy = -50;
            } else if(cena.input.comandos.get("MOVE_ABAIXO")) {
                this.vy = +50;
            } else {
                this.vy = 0;
            }
        ...
        this.adicionar(new Sprite({x: 115, y: 160, vy: -10, color: "blue", controlar: perseguePC, tags:["enemy"]})); 
